...
const page = () => {
  return (
    ...
    <div className="container mx-auto px-4 py-20">
        ...
        <h2 className="text-2xl font-bold mb-4">Introduction to Privacy Policy</h2>
        <p>This privacy policy (the &quot;Privacy Policy&quot;) applies to your use of the website of Razorpay hosted at <a href="http://razorpay.com">razorpay.com</a>, the Services (as defined under the Razorpay &quot;Terms of Use&quot;) and Razorpay applications on mobile platforms (Android, Blackberry, Windows Phone, iOS etc.) (collectively (&quot;RAZORPAY&quot; or &quot;WEBSITE&quot;)), but does not apply to any third party websites that may be linked to them, or any relationships you may have with the businesses listed on Razorpay.</p>
        <p>The terms &quot;we&quot;, &quot;our&quot; and &quot;us&quot; refer to <a href="http://razorpay.com">Razorpay</a> and the terms &quot;you&quot;, &quot;your&quot; and &quot;User&quot; refer to you, as a user of <a href="http://razorpay.com">Razorpay</a>. The term &quot;Personal Information&quot; means information that you provide to us which personally identifies you to be contacted or identified, such as your name, phone number, email address, and any other data that is tied to such information. Our practices and procedures in relation to the collection and use of Personal Information have been set-out below in order to ensure safe usage of the Website for you.</p>
        <h2 className="text-2xl font-bold mb-4">Information we collect and how we use it</h2>
        <p>We collect, receive and store your Personal Information. If you provide your third-party account credentials (&quot;Third Party Account Information&quot;) to us, you understand that some content and information in those accounts may be transmitted to your account with us if you authorise such transmissions and that Third Party Account Information transmitted to us shall be covered by this Privacy Policy.</p>
        <p>You may opt to not provide us with certain information, however that will restrict you from registering with us or availing some of our features and services.</p>
...
<p>We record information relating to your use of Razorpay, such as the searches you undertake, the pages you view, your browser type, IP
...
<p>We own all the intellectual property rights associated with the Website and its contents. No right, title or interest in any downloaded
...
and/ or compilation (meaning the collection, arrangement, and assembly) of all the content on this Website, pursuant to applicable law.</p>
<p>Our logos, product and service marks and/ or names, trademarks, copyrights and other intellectual property, whether registered or not
...
interest whatsoever, in and/ or to Our IP, without our express written permission.</p>
<h2 className="text-2xl font-bold mb-4">Cookies</h2>
<p>We send cookies to your computer in order to uniquely identify your browser and improve the quality of our service. The term &quot;cookies&quot;
...
<p>We may use the information we collect in connection with your use of Razorpay (including your Personal Information) in order to
investigate, enforce, and apply our terms and conditions and Privacy Policy.</p>
<h2 className="text-2xl font-bold mb-4">Transfer of information</h2>
<p>We do not share your Personal Information with any third party apart from financial institutions such as banks, RBI or other regulatory
...
<p>We may share your Personal Information with our parent company, subsidiaries, joint ventures, or other companies under a common
...
are not required to question or contest the validity of any search warrant, subpoena or other similar governmental request that we receive.</p>
<p>We may disclose information in the aggregate to third parties relating to User behavior in connection with actual or prospective business
...
have been exposed to, or clicked on, advertising banners.</p>
<h2 className="text-2xl font-bold mb-4">Links</h2>
<p>References on this Website to any names, marks, products or services of third parties or hyperlinks to third party websites or information
...
parties, and are not responsible for their privacy practices. We suggest you read the privacy policies on all such third party websites.</p>
<h2 className="text-2xl font-bold mb-4">User access of Personal Information</h2>
<p>As a registered Razorpay User, you can modify some of your Personal Information and your privacy preferences by accessing the
&quot;Account&quot; section of this Website.</p>
<h2 className="text-2xl font-bold mb-4">Security</h2>
<p>Your account is password protected. We use industry standard measures to protect the Personal Information that is stored in our database.
...
personnel. If you have any questions about the security on Razorpay, please contact us at <a href="mailto:disclosures@razorpay.com">disclosures@razorpay.com</a>.</p>
<p>You hereby acknowledge that Razorpay is not responsible for any intercepted information sent via the internet, and you hereby release
us from any and all claims arising out of or related to the use of intercepted information in any unauthorized manner.</p>
<h2 className="text-2xl font-bold mb-4">Terms and modifications to this Privacy Policy</h2>
<p>Our Privacy Policy is subject to change at any time without notice. To make sure you are aware of any changes, please review this policy
...
updating your Personal Information, including to provide us with your most current e-mail address.</p>
<p>If you do not wish to permit changes in our use of your Personal Information, you must notify us promptly that you wish to deactivate
...
<p>Your use of this Website will be governed by and construed in accordance with the laws of India. The Users agree that any legal action or
...
India and irrevocably submit themselves to the jurisdiction of such courts/ tribunals.</p>
<h2 className="text-2xl font-bold mb-4">Complaints and Grievance Redressal</h2>
<p>If you contact us to provide feedback, register a complaint, or ask a question, we will record any Personal Information and other content
...
Officer at the co-ordinates mentioned below in writing or by way of raising a grievance ticket through the hyperlink mentioned below:</p>
<p>
    DPO <br />
    Mr. SHASHANK KARINCHETI <br />
    Razorpay Software Private Limited <br />
    Address: No. 22, 1st Floor, SJR Cyber, Laskar - Hosur Road, Adugodi, Bangalore - 560030 <br />
    Ph: 080-46669555 <br />
    E-mail: <a href="mailto:dpo@razorpay.com">dpo@razorpay.com</a> <br />
    Grievances portal: <a href="https://razorpay.com/grievances/">https://razorpay.com/grievances/</a>
</p>
<h2 className="text-2xl font-bold mb-4">Acceptance Details</h2>
<ul className="list-disc list-inside">
  <li>Owner Id: PiufhZov1ReCtr</li>
  <li>Owner Name: Madhuraj System Solutions</li>
  <li>IP Address: 10.26.98.208</li>
  <li>Date Of Acceptance: 2025-01-13 17:38:53 IST</li>
  <li>Signatory Name: RAJU BHARATH</li>
  <li>Contact Number: +917899113311</li>
  <li>Email: madhurajsystemsolutions@gmail.com</li>
</ul>
